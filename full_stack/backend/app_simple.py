...
class SimpleJobDatabase:
    """Simple job database for testing."""
    
    def __init__(self):
        self.db_path = 'simple_jobs.db'
    ...
    def initialize(self):
        ...
        try:
            ...
            logger.info("Simple job database initialized")
            return True
    ...
    def _populate_sample_data(self, cursor):
        ...
        jobs_data = []
        for i in range(50):  # Generate only 50 sample jobs for testing
...
def test_h1b():
    ...
    h1b_probability = 85 if company in ['Google', 'Microsoft', 'Amazon'] else 45
...
def initialize_app():
    ...
    try:
        ...
        if success:
            logger.info("Simple job API ready!")
        return success
    except Exception as e:
